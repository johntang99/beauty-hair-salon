        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-subheading text-gray-600 leading-relaxed mb-8">
              Traditional Chinese Medicine offers effective, holistic treatment for a wide range of health conditions. 
              Find your concern below to learn how we can help.
            </p>
          ...
          <div className="relative lg:h-[500px] h-[350px] hidden md:block">
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--backdrop-primary)] to-[var(--backdrop-secondary)] rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-green-600/10 to-amber-600/10 relative p-8">
                ...
                <div className="absolute top-1/2 right-16 w-20 h-20 bg-green-400/15 rounded-full"></div>
                
                {/* Central Content */}
                <div className="relative z-10 text-center">
                  <div className="text-8xl mb-6">🩺</div>
                  <p className="text-gray-700 font-semibold text-subheading mb-2">Comprehensive Care</p>
                  <p className="text-gray-600 text-small">Treating the root cause, naturally</p>
                </div>
                ...
                <Image
                  ...
                  alt="Traditional Chinese Medicine conditions treatment"
                  fill
